...
for oo in np.arange(84):
	...
	if 1:
		fyes = open('auxiliar/yes_ceres_order_'+str(60+oo).zfill(3)+'.dat','w')
		fno  = open('auxiliar/no_ceres_order_'+str(60+oo).zfill(3)+'.dat','w')
		f    = open('auxiliar/ceres_order_'+str(60+oo).zfill(3)+'.dat','w')
	...
	fnoreasons = open('auxiliar/noreasons_ceres_order_'+str(60+oo).zfill(3)+'.dat','w')
